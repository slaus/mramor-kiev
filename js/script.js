...
!(function(e) {
    ...
    if (r.length > 0) {
        ...
        l.scroll(function() {
            var e = l.scrollTop();
            e > o.top + 4 ?
                r.hasClass("has-fixed") || r.addClass("has-fixed") :
                r.hasClass("has-fixed") && r.removeClass("has-fixed");
        });
    }
    var c = e("#slider");
    c.length > 0 &&
    ...
    t(),
        ...
        C.has("ul").addClass("has-children"),
        C.on({
            mouseenter: function() {
        ...
        y.on("click touchstart", function(a) {
            ...
            return (
                ("click" === a.type && i > 767) ||
                (l.hasClass("has-children") ?
                    l.hasClass("nav-opened") ?
                    (l.removeClass("nav-opened"),
                        "#" !== n || (s(l.children("ul"), "close"), !1)) :
                    (l.addClass("nav-opened"),
                        l.siblings().removeClass("nav-opened"),
                        s(l.siblings().children("ul"), "close"),
                        setTimeout(function() {
    ...
    b.length > 0 &&
        l.on("load", function() {
            b.children().fadeOut(300),
                b.delay(150).fadeOut(500),
                n.delay(100).css({
                    overflow: "visible"
                });
        });
            ...
            if (
                ...
                (s = s.length ? s : t).length &&
                    (e("html,body").animate({
                        ...
                        i < 768 &&
                        (p.find(".navbar-toggle").addClass("collapsed"),
                    ...
                    !0 !== z || grecaptcha.getResponse() ?
                        (q.slideUp(400),
                            e(a).ajaxSubmit({
                                ...
                                success: function(s) {
                                    var t =
                                        "error" === s.result ? "alert-danger" : "alert-success";
                                    q
                                        ...
                                        .slideDown(400),
                                        "error" !== s.result &&
                                        (e(a).clearForm(), !0 === z && grecaptcha.reset());
                                }
                            })) :
                        q
                        .removeClass("alert-danger alert-success")
